...
flags.DEFINE_integer("nwords", 20, "number of words")
flags.DEFINE_integer("max_words", 20, "max number of words")
flags.DEFINE_integer("max_sentences", 20, "max number of sentences")
